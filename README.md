...
Moreover, you can create a custom button by subclassing `PopupDialogButton`. The
...
I can see that there is room for more customization options. I might add more of
them over time.
